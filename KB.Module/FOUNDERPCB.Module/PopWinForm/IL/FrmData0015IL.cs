...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0015IL
    {
        #region 实例化
        DL.FrmData0015DL FrmData0015DL = null;
        FrmData0015 Frm;
        public FrmData0015IL(FrmData0015 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0015_Load(object sender, EventArgs e)
        {
            try
            {
                FrmData0015DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0015DL(Frm);
        ...
        public void textBoxFind_TextChanged(object sender, EventArgs e)
        {
            try
            {
                FrmData0015DL.BinData(" WAREHOUSE_NAME like '%" + Frm.textBoxFind.Text.Trim() + "%' or WAREHOUSE_CODE like '%" + Frm.textBoxFind.Text.Trim() + "%'");
            }
            catch (Exception e1)
            {
                log.PrintInfo(e1);
        ...
        public void dataGridView1_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Back)
                {
                    ...
                    FrmData0015DL.BinData("WAREHOUSE_CODE like '%" + Frm.statusStrip1.Items[0].Text.Trim() + "%'");
                }
                else
