...
{
	/// <summary>
	/// 业务逻辑类Approval_Mode_3BLL 的摘要说明。
	/// </summary>
	public class Approval_Mode_3BLL
	{
		private Approval_Mode_3DAL dal=null;
		#region 构造方法
		public Approval_Mode_3BLL(DBHelper DB)
		{
				dal=new Approval_Mode_3DAL(DB);
		}
		public Approval_Mode_3BLL(int factoryID)
		{
				dal=new Approval_Mode_3DAL(factoryID);
		}
		#endregion
		#region  成员方法
		...
		/// 获得数据列表
		/// </summary>
		public List<Approval_Mode_3Info> GetModelList(string strWhere)
		{
