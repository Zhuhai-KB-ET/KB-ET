...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0036IL
    {
        #region 实例化
        DL.FrmData0036DL frmData0036DL = null;
        FrmData0036 Frm;
        public FrmData0036IL(FrmData0036 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0036_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0036DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0036DL(Frm);
        ...
        public void textBoxFind_TextChanged(object sender, EventArgs e)
        {
            try
            {
                frmData0036DL.BinData(" INST_CODE like '%" + Frm.textBoxFind.Text.Trim() + "%' or PROD_ROUT_INST_1 like '%" + Frm.textBoxFind.Text.Trim() + "%'  ");
            }
            catch (Exception e1)
            {
                log.PrintInfo(e1);
        ...
        public void dataGridView1_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Back)
                {
                    ...
                    frmData0036DL.BinData("INST_CODE like '%" + Frm.statusStrip1.Items[0].Text.Trim() + "%'");
                }
                else
