...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0008IL
    {
        #region 实例化
        DL.FrmData0008DL frmData0008DL = null;
        FrmData0008 Frm;
        public FrmData0008IL(FrmData0008 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0008_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0008DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0008DL(Frm);
        ...
        public void textBoxFind_TextChanged(object sender, EventArgs e)
        {
            try
            {
                frmData0008DL.BinData(" PRODUCT_NAME like '%" + Frm.textBoxFind.Text.Trim() + "%' or PROD_CODE like '%" + Frm.textBoxFind.Text.Trim() + "%'");
            }
            catch (Exception e1)
            {
                log.PrintInfo(e1);
        ...
        public void dataGridView1_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Back)
                {
                    ...
                    frmData0008DL.BinData("PROD_CODE like '%" + Frm.statusStrip1.Items[0].Text.Trim() + "%'");
                }
                else
