...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0023IL
    {
        #region 实例化
        DL.FrmData0023DL frmData0023DL = null;
        FrmData0023 Frm;
        public FrmData0023IL(FrmData0023 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0023_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0023DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0023DL(Frm);
        ...
        public void textBoxFind_TextChanged(object sender, EventArgs e)
        {
            try
            {
                frmData0023DL.BinData(" CODE like '%" + Frm.textBoxFind.Text.Trim() + "%' or SUPPLIER_NAME like '%" + Frm.textBoxFind.Text.Trim() + "%'");
            }
            catch (Exception e1)
            {
                log.PrintInfo(e1);
        ...
        public void dataGridView1_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Back)
                {
                    ...
                    frmData0023DL.BinData("CODE like '%" + Frm.statusStrip1.Items[0].Text.Trim() + "%'");
                }
                else
