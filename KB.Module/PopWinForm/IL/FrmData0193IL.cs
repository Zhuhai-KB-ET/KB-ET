...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0193IL
    {
        #region 实例化
        DL.FrmData0193DL frmData0193DL = null;
        FrmData0193 Frm;
        public FrmData0193IL(FrmData0193 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0193_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0193DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0193DL(Frm);
        ...
        public void textBoxFind_TextChanged(object sender, EventArgs e)
        {
            try
            {
                frmData0193DL.BinData(" CODE like '%" + Frm.textBoxFind.Text.Trim() + "%'");
            }
            catch (Exception e1)
            {
                log.PrintInfo(e1);
        ...
        public void dataGridView1_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Back)
                {
                    ...
                    frmData0193DL.BinData("CODE like '%" + Frm.statusStrip1.Items[0].Text.Trim() + "%'");
                }
                else
