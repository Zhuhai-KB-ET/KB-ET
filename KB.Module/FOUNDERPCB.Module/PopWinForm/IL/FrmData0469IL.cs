...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0469IL
    {
        #region 实例化
        DL.FrmData0469DL frmData0469DL = null;
        FrmData0469 Frm;
        public FrmData0469IL(FrmData0469 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0469_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0469DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0469DL(Frm);
        ...
        public void textBoxFind_TextChanged(object sender, EventArgs e)
        {
            try
            {
                frmData0469DL.BinData(" PARAMETER_CODE like '%" + Frm.textBoxFind.Text.Trim() + "%' or PARAMETER_DESC like '%" + Frm.textBoxFind.Text.Trim() + "%'  ");
            }
            catch (Exception e1)
            {
                log.PrintInfo(e1);
        ...
        public void dataGridView1_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Back)
                {
                    ...
                    frmData0469DL.BinData("PARAMETER_CODE like '%" + Frm.statusStrip1.Items[0].Text.Trim() + "%'");
                }
                else
