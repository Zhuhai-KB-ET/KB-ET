...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0103IL
    {
        #region 实例化
        DL.FrmData0103DL frmData0103DL = null;
        FrmData0103 Frm;
        public FrmData0103IL(FrmData0103 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0103_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0103DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0103DL(Frm);
        ...
        public void textBoxFind_TextChanged(object sender, EventArgs e)
        {
            try
            {
                frmData0103DL.BinData(" GL_ACC_NUMBER like '%" + Frm.textBoxFind.Text.Trim() + "%' or GL_DESCRIPTION like '%" + Frm.textBoxFind.Text.Trim() + "%'");
            }
            catch (Exception e1)
            {
                log.PrintInfo(e1);
        ...
        public void dataGridView1_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Back)
                {
                    ...
                    frmData0103DL.BinData("GL_ACC_NUMBER like '%" + Frm.statusStrip1.Items[0].Text.Trim() + "%'");
                }
                else
