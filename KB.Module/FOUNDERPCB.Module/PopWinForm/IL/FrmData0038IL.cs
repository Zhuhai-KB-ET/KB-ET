...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0038IL
    {
        #region 实例化
        DL.FrmData0038DL frmData0038DL = null;
        FrmData0038 Frm;
        public FrmData0038IL(FrmData0038 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0038_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0038DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0038DL(Frm);
