...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0017SemiInvIL
    {
        #region 实例化
        DL.FrmData0017SemiInvDL frmData0017InvDL = null;
        FrmData0017SemiInv Frm;
        public FrmData0017SemiInvIL(FrmData0017SemiInv psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0017SemiInv_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0017InvDL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0017SemiInvDL(Frm);
        ...
        public void dataGridView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            try
            {
                Frm.ReturnValue = Frm.dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim() + "|" +
                                  ...
                                  Frm.dataGridView1.CurrentRow.Cells[10].Value.ToString().Trim() + "|";
