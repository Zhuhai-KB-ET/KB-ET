...
namespace FOUNDERPCB.Module.PopWinForm.IL
{
    ...
    /// 业务中间层
    /// </summary>
    public partial class FrmData0037IL
    {
        #region 实例化
        DL.FrmData0037DL frmData0037DL = null;
        FrmData0037 Frm;
        public FrmData0037IL(FrmData0037 psFrm)
        {
            Frm = psFrm;
        ...
        public void FrmData0037_Load(object sender, EventArgs e)
        {
            try
            {
                frmData0037DL = new FOUNDERPCB.Module.PopWinForm.DL.FrmData0037DL(Frm);
        ...
        public void textBoxFind_TextChanged(object sender, EventArgs e)
        {
            try
            {
                frmData0037DL.BinData(" PROD_ROUTE_CODE like '%" + Frm.textBoxFind.Text.Trim() + "%' or PROD_ROUTE_CODE_NAME like '%" + Frm.textBoxFind.Text.Trim() + "%'");
            }
            catch (Exception e1)
            {
                log.PrintInfo(e1);
        ...
        public void dataGridView1_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Back)
                {
                    ...
                    frmData0037DL.BinData("PROD_ROUTE_CODE like '%" + Frm.statusStrip1.Items[0].Text.Trim() + "%'");
                }
                else
